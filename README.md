...
- (3) a compile plugin: tex_complile.vim (~/.vim/ftplugin/tex/compile.vim, depends on ~/.vim/compiler/latexmk.vim), https://www.vim.org/scripts/script.php?script_id=6060
...
- (5) a template plugin: template.vim (~/.vim/ftplugin/tex/template.vim, depends on ~/.vim/ftplugin/tex/template/)
